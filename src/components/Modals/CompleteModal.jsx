...
const CompleteModal = ({taskId, taskTitle}) => {
        ...
        <div className="bg-[#fff] w-full flex flex-col">
          ...
          >
            ...
            <div className="flex flex-col w-full mt-3 text-center sm:mt-0 sm:text-left">
                ...
                <div className="mt-5">
                  <div>Are you sure you want to mark the task: &lsquo;{taskTitle}&rsquo; as completed?</div>
                </div>
              </div>
            </div>
            <div className="flex justify-end items-center">
              ...
              >
                {isChangingTaskStatus ? <Loader /> : "Yes, Mark as done"}
              </button>
            </div>
          </form>
        </div>
