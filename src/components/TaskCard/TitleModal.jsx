...
const TitleModal = ({ taskTitle, titleModal, handleTitleModal, changeTitle, id }) => {
  const [newTitle, setNewTitle] = useState(taskTitle? taskTitle : "");
            ...
            <div className="sm:flex sm:items-start">
              <div className="flex flex-col w-full mt-3 text-center sm:mt-0 sm:text-left">
                <h3 className="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                  Change the title of this task
                </h3>
                <div className="mt-5">
                  <input 
                    type='text'
                    placeholder='Enter the new title for the task'
                    value={newTitle}
