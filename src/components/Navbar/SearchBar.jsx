...
const SearchBar = () => {
  ...
  return (
    <div className="flex items-center bg-[#F0ECEC] py-1 px-2 w-full max-w-[400px]">
      <svg className="pr-1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      <input name="search" type="search" placeholder="Search..." value={searchValue} onChange={handleSearchChange} className="border-none outline-none bg-transparent w-full" />
    </div>
  )
}
